# EIPSA Manuscript — Extracted Sections from Conversation Transcript

*Extracted from: 66171407-1a71-4dcb-a124-570c81747ec1.jsonl*

---

# SECTION 1: REVISED TITLE
...
**Revealed, Not Created: Social Cohesion, Lockdown Strategy, and the Structural Roots of Polarization in OECD Nations**
...
Our findings reveal a governance paradox. First, we report a null result: COVID-19 mortality — the proximate operationalization of pathogen-driven fear — does not predict changes in liberal democracy, judicial constraints, or social polarization across OECD nations. The parasite-stress mechanism, whatever its validity over evolutionary timescales, does not appear to operate through pandemic mortality in contemporary developed democracies. Second, we identify lockdown stringency as the salient predictor: countries that imposed stricter containment measures experienced significantly greater increases in social polarization between 2019 and 2024. Third, and most critically, we demonstrate that this relationship is confounded by a selection effect. Pre-pandemic social cohesion — measured by V-Dem's social polarization index in 2019 — was strongly negatively correlated with subsequent lockdown stringency (*r* = −0.51, *p* = 0.001). Societies with high pre-existing cohesion, notably the Nordic countries and Japan, achieved pandemic compliance through voluntary behavioral adaptation, requiring minimal legal coercion. Societies with low cohesion, including the United States, Italy, and Chile, were compelled to substitute trust with mandates — mandates that subsequently deepened the very divisions they were meant to manage.

The remainder of this paper proceeds as follows. Section 2 reviews the theoretical and empirical literature linking pathogen stress to political outcomes. Section 3 describes the data and empirical strategy. Section 4 presents the main results, including the null mortality finding, the stringency–polarization association, and the selection mechanism. Section 5 discusses the implications for democratic governance in the post-pandemic era, and Section 6 concludes.

*662 words. 4 placeholder citations marked with `[Ref]`.* The confirmed citations are:

- **Thornhill & Fincher (2014)** — *The Parasite-Stress Theory of Values and Sociality*, Springer.
- **Murray & Schaller (2010)** — Behavioral immune system and authoritarianism, *Psychological Inquiry*.
- **Norris & Inglehart (2019)** — *Cultural Backlash: Trump, Brexit, and Authoritarian Populism*, Cambridge UP.
- **Levitsky & Ziblatt (2018)** — *How Democracies Die*, Crown.
- **Edgell et al. (2021)** — Pandemic Backsliding project, V-Dem Institute.
- **Hale et al. (2021)** — OxCGRT, *Nature Human Behaviour*.
- **Coppedge et al. (2025)** — V-Dem v15 dataset.
- **Guha-Sapir et al. (2025)** — EM-DAT, CRED/UCLouvain.
- **Mathieu et al. (2021)** — OWID COVID-19 dataset, *Nature Human Behaviour*.
...
# SECTION 5: REVISED RESULTS (with corrected v2smpolsoc direction)
...
For high-trust nations — Japan, the Nordic countries, New Zealand — the pandemic confirmed what was already known: these societies possess deep reservoirs of social capital that enable collective action without formal coercion. Low stringency in these countries was not laxity. It was *efficiency*. The social infrastructure was strong enough to coordinate a population-level behavioral response through norms, expectations, and voluntary compliance alone. These nations passed the stress test, but the test did not make them stronger. Their cohesion continued the same gradual decline observed across the OECD as a whole.
...
This finding speaks to the structural nature of polarization in advanced democracies. The forces driving social division — economic inequality, cultural sorting, media fragmentation, algorithmic amplification, declining institutional trust — operate on timescales and through mechanisms that a single exogenous shock, however severe, cannot easily override. The pandemic was the most significant global disruption since the Second World War, yet its effect on the trajectory of OECD social cohesion was, within the precision of our measurement, zero. If a pandemic cannot bend the curve of polarization, the forces producing it must be deeply embedded in the political economy of contemporary democracies.
...
## 20 New Expanded References

### Theme A: Critiques of Parasite-Stress Theory
...
### Theme B: COVID-19 & Democratic Resilience/Backsliding
...
### Theme C: Social Trust & Voluntary Compliance
...
### Theme D: Structural Drivers of Polarization
...
**Total bibliography: 29 references** (9 original + 20 new)

---

# SECTION 9: REVISION GUIDE

## Part 1: The Fukuyama Verification

Fukuyama (1995) provides the *general theory* of trust and prosperity, but he wrote a far more directly relevant piece during the pandemic:

**Fukuyama, F. (2020). The pandemic and political order. *Foreign Affairs*, *99*(4), 26–32.**

In this article, Fukuyama argues explicitly that the key variable determining pandemic performance was not regime type (democracy vs. autocracy) but *state capacity* combined with *social trust*. He writes that societies with high trust could implement effective responses without heavy coercion — precisely our argument.

**Recommendation:** Cite both. Use Fukuyama (1995) for the foundational theory of trust as social capital, and Fukuyama (2020) for the direct application to pandemic governance.

## Part 2: Specific Revisions

### A. Introduction — Contextualizing the Debate

---

**Revision A1: Contesting the theory**

**Section:** Introduction, paragraph 1

**Original:**
> Cross-national evidence has broadly supported this framework: regions with higher parasite stress tend to exhibit more authoritarian governance, greater ethnocentrism, and reduced interpersonal trust (Thornhill & Fincher, 2014; Murray & Schaller, 2010). When COVID-19 emerged as a global pandemic in early 2020, these theoretical priors generated a clear prediction.

**Revised:**
> Cross-national evidence has been cited in support of this framework: regions with higher parasite stress tend to exhibit more authoritarian governance, greater ethnocentrism, and reduced interpersonal trust (Thornhill & Fincher, 2014; Murray & Schaller, 2010). However, the theory has faced sustained methodological challenge. **Hackman and Hruschka (2013)** demonstrated that the original statistical analyses do not withstand scrutiny when issues of non-independence and confounding are addressed. **Pollet, Tybur, Frankenhuis, and Rickard (2014)** warned that country-level correlations between pathogen prevalence and cultural values suffer from the ecological fallacy, with individual-level effects far weaker than aggregate patterns suggest. And **Tybur et al. (2016)**, in a 30-nation study, found that pathogen avoidance relates specifically to sexual conservatism rather than to authoritarianism broadly — a far narrower effect than the theory predicts. Nevertheless, when COVID-19 emerged as a global pandemic in early 2020, the theoretical priors of the parasite-stress framework generated a clear prediction.

**Why this fits:** Establishes that the theory the paper tests is already contested, strengthening the rationale for an empirical test and making the null result less surprising in isolation.

---

**Revision A2: Citing the "pandemic authoritarianism" scholars**

**Section:** Introduction, paragraph 1

**Original:**
> Scholars warned of an impending wave of "pandemic authoritarianism," in which fear of contagion would accelerate democratic backsliding worldwide [Ref]. The ingredients appeared to be in place: emergency powers were invoked across democracies, civil liberties were curtailed, and executive discretion expanded with minimal legislative oversight (Edgell et al., 2021).
...
**Why this fits:** Replaces the [Ref] placeholder with specific, verified citations and adds the Freedom House report as an institutional voice in the debate.

---

**Revision A3: Grounding structural polarization**

**Section:** Introduction, paragraph 2

**Original:**
> Democratic backsliding in the developed world was already a subject of scholarly concern before COVID-19, driven by populist mobilization, affective polarization, and declining trust in institutions (Norris & Inglehart, 2019; Levitsky & Ziblatt, 2018).

**Revised:**
> Democratic backsliding in the developed world was already a subject of scholarly concern before COVID-19, driven by populist mobilization, affective polarization, and declining trust in institutions (Norris & Inglehart, 2019; Levitsky & Ziblatt, 2018). Affective polarization — the tendency to view political opponents with hostility independent of policy disagreement — had been rising across Western democracies since the 1980s (**Iyengar, Lelkes, Levendusky, Malhotra, & Westwood, 2019**), and **Boxell, Gentzkow, and Shapiro (2022)** documented its cross-country spread across twelve OECD nations over decades, establishing it as a structural phenomenon long predating the pandemic.

**Why this fits:** Grounds the "pre-existing polarization" claim in specific empirical literature, directly supporting Figure 1's depiction of a secular decline starting well before 2020.

---

**Revision A4: Filling the remaining literature gap**

**Section:** Introduction, paragraph 3

**Original:**
> Much of the existing literature on COVID-19 and democracy treats the virus and the response as a single exogenous shock, examining composite indices of "pandemic impact" without disentangling mortality from mitigation [Ref]. Studies that do differentiate between the two tend to focus on individual-level survey data [Ref].

**Revised:**
> Much of the existing literature on COVID-19 and democracy treats the virus and the response as a single exogenous shock, examining composite indices of "pandemic impact" without disentangling mortality from mitigation (**Lührmann & Lindberg, 2019**; **Maerz et al., 2020**). Studies that do differentiate between the two tend to focus on individual-level survey data — attitudes toward democracy, trust in government, compliance behavior (**Van Bavel et al., 2020**) — rather than on country-level institutional and social outcomes measured longitudinally.

**Why this fits:** Replaces both [Ref] placeholders with verified sources, with Lührmann & Lindberg contextualizing the autocratization wave and Van Bavel et al. representing the individual-level behavioral approach.

---

### B. Results — The Missing EM-DAT Analysis

---

**Revision B1: New opening paragraph**

**Section:** Section 4, insert before Section 4.1

**Original:** *(nothing — this section was missing)*
...
**Why this fits:** Fills the methodological gap the user identified (EM-DAT mentioned in Methods but absent from Results) and ties the historical null to the contemporary null via Pasin et al.

---

### C. Discussion — Strengthening the Argument

---

**Revision C1: Parasite-stress revisited**

**Section:** Discussion, Section 5.1

**Original:**
> Our findings challenge the applicability of this framework to contemporary high-income democracies on two fronts. First, COVID-19 mortality bore no detectable relationship to changes in social polarization — the biological threat channel is null. Second, the coercive policy instruments deployed in response to the pandemic also failed to move the needle.
...
**Why this fits:** Transforms an assertion ("our findings challenge...") into an empirically grounded argument situated within an existing critical literature.

---

**Revision C2: Voluntary compliance — the core paragraph**

**Section:** Discussion, Section 5.2

**Original:**
> For high-trust nations — Japan, the Nordic countries, New Zealand — the pandemic confirmed what was already known: these societies possess deep reservoirs of social capital that enable collective action without formal coercion. Low stringency in these countries was not laxity. It was *efficiency*.
...
**Why this fits:** Transforms an unsupported assertion into a richly cited empirical argument, with four distinct studies and two theoretical frameworks all converging on the same mechanism.

---

**Revision C3: Structural stubbornness of polarization**

**Section:** Discussion, Section 5.3

**Original:**
> The forces driving social division — economic inequality, cultural sorting, media fragmentation, algorithmic amplification, declining institutional trust — operate on timescales and through mechanisms that a single exogenous shock, however severe, cannot easily override.
...
**Why this fits:** Grounds the "structural polarization" claim in three of the most cited empirical studies in the field, making the null pandemic finding a predictable consequence of established theory rather than an anomaly.

---

### Summary of Revision Guide changes:

| Revision | Section | Type | Key Citations Added |
|----------|---------|------|---------------------|
| A1 | Introduction, para 1 | Theory critique | Hackman & Hruschka (2013); Pollet et al. (2014); Tybur et al. (2016) |
| A2 | Introduction, para 1 | Pandemic authoritarianism | Maerz et al. (2020); Thomson & Ip (2020); Repucci & Slipowitz (2021) |
| A3 | Introduction, para 2 | Structural polarization | Iyengar et al. (2019); Boxell et al. (2022) |
| A4 | Introduction, para 3 | Literature gap | Lührmann & Lindberg (2019); Maerz et al. (2020); Van Bavel et al. (2020) |
| B1 | Results, new Section 4.0 | EM-DAT analysis | Guha-Sapir et al. (2025); Pasin et al. (2024) |
| C1 | Discussion, Section 5.1 | Parasite-stress critique | Pasin et al. (2024); Hackman & Hruschka (2013); Pollet et al. (2014) |
| C2 | Discussion, Section 5.2 | Voluntary compliance | Fukuyama (1995, 2020); Bargain & Aminjonov (2020); Durante et al. (2021); Bartscher et al. (2021); Van Bavel et al. (2020) |
| C3 | Discussion, Section 5.3 | Structural polarization | Iyengar et al. (2019); McCarty et al. (2016); Boxell et al. (2017) |
